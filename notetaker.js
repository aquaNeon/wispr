...
(function () {
    ...
    var CONTENT = [
      ...
      { name: 'DeShawn', text: 'Agreed. I’ll flag it.', task: 'Flag demo-space change' },
      ...
      { name: 'Hailey', text: 'Yep, I’ll review it with Product and Eoin.', task: 'Review demo with Product and Eoin' },
      ...
      { name: 'Hailey', text: 'I’ll let them know.', task: 'Tell Eng: tentatively 11am–2pm' },
      ...
      { name: 'DeShawn', text: 'I’ll send it to Yao tomorrow morning.', task: 'Send Yao priority list tomorrow AM' },
      { name: 'Mark', text: 'Thanks. I’ll check their progress Friday.', task: 'Check Sales outreach Friday' },
      ...
      { name: 'Alix', text: 'Reminding them now.', task: 'Remind team: CES travel due 8th' },
      { name: 'Alix', text: 'Expense reports go through Ramp, right?', task: '' },
      { name: 'DeShawn', text: 'Yes. We switched over last month.', task: '' },
      { name: 'Hailey', text: 'I’ll note that in the event channel too.', task: 'Post Ramp reminder in event channel' },
